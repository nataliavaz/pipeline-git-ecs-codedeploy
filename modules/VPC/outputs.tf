output "vpc_id" {
  ...
  value       = concat(module.aws_vpc.*.vpc_id, [""])[0]
}
...
output "database_subnets" {
  ...
  value       = concat(module.aws_vpc.*.database_subnets, [""])[0]
}

output "elasticache_subnets" {
  description = "List of IDs of elasticache subnets"
  value       = concat(module.aws_vpc.*.elasticache_subnets, [""])[0]
}

output "intra_subnets" {
  description = "List of IDs of intra subnets"
  value       = concat(module.aws_vpc.*.intra_subnets, [""])[0]
}

output "private_subnets" {
  description = "List of IDs of private subnets"
  value       = concat(module.aws_vpc.*.private_subnets, [""])[0]
}

output "public_subnets" {
  description = "List of IDs of public subnets"
  value       = concat(module.aws_vpc.*.public_subnets, [""])[0]
}

output "vpc_cidr_block" {
  description = "The CIDR block of the VPC"
  value       = concat(module.aws_vpc.*.vpc_cidr_block, [""])[0]
}

# output "database_subnet_group" {
#   description = "ID of database subnet group"
#   value       = concat(module.aws_vpc.*.database_subnet_group, [""])[0]
# }
...
#   value       = concat(module.aws_vpc.*.vpc_arn, [""])[0]
# }
